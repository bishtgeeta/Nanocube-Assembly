...
fileName = r'Z:\Geeta-Share\rod assembly\20170228-009(1)-output\output\imgDataNM - Copy.dat'
outputDir = inputDir
gImg = cv2.imread(r'Z:\Geeta-Share\rod assembly\20170228-009(1)-output\output\dataProcessing\gImgRawStack\000001.png',0)
